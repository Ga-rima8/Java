...
<head>
    ...
    <title>GHOST ELEMENTS | Social Portal</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/Social.css">
</head>
<body>
...
<div class="container">
    ...
    <div class="filter-bar">
        ...
        <div class="filter-link" onclick="filterData('Air', this)">Communicating</div>
        <div class="filter-link" onclick="filterData('Water', this)">Celebration</div>
        <div class="filter-link" onclick="filterData('Land', this)">Activities</div>
    </div>
