...
.perks { display: flex; flex-direction: column; gap: 10px; margin-top: 18px; }
.perk-item {
  display: flex;
  align-items: center;
  gap: 10px;
...
.input-group select option { background: #0d2818; color: var(--text-primary); }
...
.input-group select:hover:not(:focus) { border-color: rgba(163,230,53,0.28); }
...
<main class="split-container">
  ...
  <div class="left-side">
    <div class="image-card">
      <img src="${pageContext.request.contextPath}/img/pic1.jpg" alt="HangAura" class="side-image">
        ...
        <div class="input-row">
          <div class="input-group">
            <select name="gender" required>
              ...
              <option value="Other"  ${gender == 'Other'  ? 'selected' : ''}>Prefer not to say</option>
            </select>
          </div>
          <div class="input-group">
