...
<head>
    ...
    <title>GHOST ELEMENTS | Creative Portal</title>
...
<div class="container">
    ...
    <div class="filter-bar">
        ...
        <div class="filter-link" onclick="filterData('Air', this)">Visual</div>
        <div class="filter-link" onclick="filterData('Water', this)">Performative</div>
        <div class="filter-link" onclick="filterData('Land', this)">Literary</div>
    </div>
